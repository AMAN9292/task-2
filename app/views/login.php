...
<div class="d-flex align-items-center justify-content-center" style="min-height:100vh;background:#f3f4f6;">
  <div class="card shadow-sm" style="width:100%;max-width:420px;border-radius:12px;overflow:hidden;">
    ...
    <div class="card-body p-4">
      ...
      <p class="text-muted mb-4" style="font-size:13px;">Enter your admin credentials to continue</p>
      ...
      <form method="POST" action="index.php?module=auth">
        <div class="mb-3">
        ...
        <div class="mb-4">
          ...
          <div class="input-group">
            ...
            <button type="button" class="btn btn-outline-secondary" onclick="togglePw()" tabindex="-1">
